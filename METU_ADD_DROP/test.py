...
def check_lesson():
    ...
    if len(filtered_table) == 0:
        sys.exit("[ERR] Check whether your courses in lessonList are in your current courses.")
        ...
        while 1:
            ...
            for order, lesson in enumerate(lessonList):
                ...
                for sectionCode in sectionList:
                    ...
                    driver.get("http://localhost:8000/Desktop/Registration3.html")
