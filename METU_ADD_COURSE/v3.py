...
NOT INCLUDED = 6
"""
desired_time = "11:00:00"

def start_process():
    time_loop(desired_time)
...
if __name__ == "__main__":
    ...
    try:
        WebDriverWait(driver, 3).until(EC.presence_of_element_located((By.XPATH, '//input[@name="submitAddCourse"]')))
    except:
        input("2nd Type to continue...")
    ...
    for order, lesson in enumerate(lessonList):
        ...
        try:
            WebDriverWait(driver, 2).until(EC.presence_of_element_located((By.XPATH, '//input[@name="submitAddCourse"]')))
        except:
            pass
